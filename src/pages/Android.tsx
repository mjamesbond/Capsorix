...
const CAPABILITY_ICONS = [Cpu, Layers, ShieldCheck, Boxes, Zap, CheckCircle2] as const;

const Android = () => {
  const heroParallax = useParallax<HTMLDivElement>(0.1);
  const { t, dir } = useI18n();
  const s = t.subpages.android;
        ...
        <div className="container relative">
          <Reveal className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="font-display text-5xl md:text-7xl lg:text-[6rem] font-medium leading-[0.95] tracking-tight">
              {s.titleA}
              <span className="text-gradient-gold italic">{s.titleKotlin}</span>
              <br />
          ...
          {/* Android Studio–style workspace — chrome stays in English */}
