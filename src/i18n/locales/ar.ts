...
const ar: Dict = {
    ...
    caseStudies: {
      ...
      items: [
        ...
        {
          tag: "تعليم حكومي · مدرسة حكوميّة · تحوّل رقمي",
          client: "مدرسة الناصريّة الابتدائيّة الجديدة",
          title: "مدرسة الناصريّة الابتدائيّة الجديدة — منصّة مؤسّسيّة حديثة.",
          summary:
            "منصّة رقميّة راقية ثنائيّة اللغة طُوِّرت لمدرسة ابتدائيّة حكوميّة، تجمع بين الهويّة المؤسّسيّة والموارد التعليميّة وإدارة المحتوى الإداري وتجربة عصريّة للطلاب وأولياء الأمور والمعلّمين وإدارة المدرسة.",
          challenge:
            "صُمِّمت لتحديث الحضور الرقمي للمدرسة مع الحفاظ على هويّتها التعليميّة. تُوحِّد المنصّة الإعلانات والجداول الأكاديميّة ولوحة الشرف والإنجازات والأنشطة ومعارض الوسائط وقنوات التواصل والمعلومات المؤسّسيّة في تجربة موحّدة يمكن الوصول إليها عبر جميع الأجهزة.",
          approach:
            "هُندست كمنصّة تعليميّة قابلة للتوسّع بنظام إدارة محتوى إداري آمن، وبنية جاهزة للتعدّد اللغوي، وواجهة متجاوبة، وتحسين لمحرّكات البحث، وإدارة محتوى منظّمة، ومعارض صور، وموارد أكاديميّة، وقابليّة صيانة بمستوى المؤسّسات. كل قسم عام قابل للإدارة من خلال لوحة إداريّة داخليّة دون التأثير على تجربة المستخدم.",
          stack: ["React", "TypeScript", "Supabase", "Tailwind CSS", "CMS", "منصّة تعليميّة", "تصميم متجاوب", "SEO", "إدارة بالأدوار", "إدارة المحتوى", "معارض الصور", "بوّابة أكاديميّة"],
          metrics: [
            { value: "حكومي", label: "تعليم عام" },
            { value: "CMS", label: "بإدارة المسؤولين" },
            { value: "متجاوب", label: "كلّ الأجهزة" },
          ],
          duration: "منصّة مؤسّسيّة",
          status: "مكتمل — تسليم المنصّة الرقميّة الرسميّة بنجاح لمدرسة الناصريّة الابتدائيّة الجديدة، بموقع مؤسّسي آمن وحديث وقابل للتوسّع، مع إدارة محتوى مركزيّة للمشرفين وتجربة عامّة مُحسَّنة للطلاب وأولياء الأمور.",
          href: "https://www.newnasiriya.com",
          visitLabel: "زيارة newnasiriya.com",
          logo: "nasiriya",
        },
      ],
    },
